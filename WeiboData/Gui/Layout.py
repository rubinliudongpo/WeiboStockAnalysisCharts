...
class Ui_Main_Window(object):
    def setup_ui(self, MainWindow):
        ...
        self.weibo_id_label.setAlignment(QtCore.Qt.AlignLeading | QtCore.Qt.AlignVCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.interval_combobox.setItemText(0, _translate("MainWindow", "D", "by date"))
        self.interval_combobox.setItemText(1, _translate("MainWindow", "W", None))
        self.interval_combobox.setItemText(2, _translate("MainWindow", "M", None))
        self.interval_combobox.setItemText(3, _translate("MainWindow", "5", None))
        self.interval_combobox.setItemText(4, _translate("MainWindow", "15", None))
        self.interval_combobox.setItemText(5, _translate("MainWindow", "30", None))
        self.interval_combobox.setItemText(6, _translate("MainWindow", "60", None))
